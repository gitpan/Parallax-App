# This Makefile is for the Parallax::App extension to perl.
#
...
#     ABSTRACT => q[RESTful web text API for Nerds]
...
#     NAME => q[Parallax::App]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Net::GitHub=>q[0.46], Dancer=>q[1.3095] }
#     VERSION_FROM => q[lib/Parallax/App.pm]
#     clean => { FILES=>q[Parallax-App-*] }
...
MAKE = make
FULLEXT = Parallax/App
BASEEXT = App
PARENT_NAME = Parallax
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Parallax
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Parallax
...
TO_INST_PM = lib/Parallax/App.pm \
	lib/Parallax/Github.pm

PM_TO_BLIB = lib/Parallax/Github.pm \
	blib/lib/Parallax/Github.pm \
	lib/Parallax/App.pm \
	blib/lib/Parallax/App.pm
...
DISTNAME = Parallax-App
DISTVNAME = Parallax-App-0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''RESTful web text API for Nerds'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''MAHMUT BULUT <mahmutbulut0@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Parallax-App' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Net::GitHub: 0.46' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "RESTful web text API for Nerds",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "MAHMUT BULUT <mahmutbulut0@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Parallax-App",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Net::GitHub" : "0.46",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>RESTful web text API for Nerds</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>MAHMUT BULUT &lt;mahmutbulut0@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::" VERSION="1.3095" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Net::GitHub" VERSION="0.46" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Parallax/Github.pm blib/lib/Parallax/Github.pm \
	  lib/Parallax/App.pm blib/lib/Parallax/App.pm 
